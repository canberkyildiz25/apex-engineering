    ...
    <footer className="relative border-t border-accent-cyan/10 bg-steel-950 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mt-10 flex items-center gap-4">
          <span className="font-mono text-[9px] text-accent-cyan/30 tracking-widest">CONNECT</span>
          <div className="h-px flex-1 bg-accent-cyan/10" />
          <a
            href="https://github.com/canberkyildiz25/apex-engineering"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-4 py-2 border border-accent-cyan/15 hover:border-accent-cyan/40 hover:bg-accent-cyan/5 transition-all clip-corner-sm"
            aria-label="GitHub"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 text-accent-silver/50 group-hover:text-accent-cyan transition-colors" fill="currentColor">
            ...
            <span className="font-mono text-[10px] text-accent-silver/40 group-hover:text-accent-cyan transition-colors tracking-widest">
              GITHUB
            </span>
          </a>
          <a
        ...
        {/* Bottom bar */}
        <div className="mt-8 pt-6 border-t border-accent-cyan/10 flex flex-col md:flex-row items-center justify-between gap-4">
